...
const MobileMockupTheme: React.FC<ThemeProps> = ({ config }) => {
  ...
  return (
    <div className={`overflow-hidden w-full h-full justify-center relative`} data-cover-root style={backgroundStyle}>
      ...
      <div
        className={`h-full flex items-center relative z-10 ${size.value.indexOf('vertical') === 0 ? 'flex-col px-24 py-12' : ''} ${
